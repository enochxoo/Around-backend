...
const (
	...
	ES_URL      = "http://35.227.102.16:9200"
	BUCKET_NAME = "gopj"

	// Needs to update with your real project id
	ENABLE_BIGTABLE     = false
	BIGTABLE_PROJECT_ID = "spiritual-block-200023"
...
func saveToBigTable(p *Post, id string) {
	...
	bt_client, err := bigtable.NewClient(ctx, BIGTABLE_PROJECT_ID, BT_INSTANCE, option.WithCredentialsFile("spiritual-block-200023-f26b110893df.json"))
	if err != nil {
		panic(err)
		return
	}
